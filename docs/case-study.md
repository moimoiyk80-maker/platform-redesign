...
B2B 제품 콘텐츠와 여러 웹 채널을 운영하는 실무 환경에서,
...
회사 식별 가능성과 보안 문제로 기존 작업물을 공개할 수 없어,
실무에서 관찰한 정보구조와 사용자 경험 문제를 비식별화하고
...
### Product User / Operator

사용 목적과 운영 환경에 적합한 제품을 찾고,
주요 기능과 모델별 차이, 상세 사양을 비교하는 사용자입니다.
...
여러 제품 후보의 조건과 자료를 비교하고,
도입 가능성과 문의에 필요한 정보를 검토하는 사용자입니다.
